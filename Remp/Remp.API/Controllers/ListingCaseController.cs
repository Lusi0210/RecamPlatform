...
namespace Remp.Remp.API.Controllers
{
    ...
    public class ListingCaseController : ControllerBase
    {
        ...
        public async Task<ActionResult<ListingCaseResponseDto>> CreateListingCase([FromBody] CreateListingCaseRequestDto listingCaseCreateDto)
        {
            ...
            return Created("GetListingCaseById", responseDto);
        }

        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<List<ListingCaseResponseDto>>> GetAllListingCases()
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<ListingCaseResponseDto>> GetListingCaseById(int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<ListingCaseResponseDto>> UpdateListingCase(int id, [FromBody] UpdateListingCaseRequestDto listingCaseUpdateDto)
        {
        ...
        public async Task<ActionResult<ListingCaseResponseDto>> UpdateListingCaseStatus(int id, [FromBody] UpdateListingCaseStatusRequestDto statusUpdateDto)
        {
